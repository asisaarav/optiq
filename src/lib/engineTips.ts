...
export const ENGINE_TIPS: Record<TipsKey, Tip[]> = {
  POSTGRESQL: [
    {
      ...
      title: "Declarative range partitioning",
    ...
    {
      category: "Indexing",
      title: "Covering & partial indexes",
    ...
    {
      category: "Statistics & Planner",
      title: "Boost statistics on skewed columns",
    ...
    {
      category: "Functions & UDFs",
      title: "Mark functions IMMUTABLE / STABLE",
  ...
  MYSQL: [
    ...
    {
      category: "Indexing",
      title: "Covering indexes & InnoDB clustered PK",
  ...
  ORACLE: [
    ...
    {
      category: "Statistics & Planner",
      title: "Histograms on skewed columns",
  ...
  "PL/SQL": [
    ...
    },
    {
      ...
      title: "RESULT_CACHE for read-heavy lookups",
  ...
  REDSHIFT: [
    ...
    {
      category: "Concurrency / Threading",
      title: "WLM queues + Concurrency Scaling",
    ...
    {
      category: "Memory & Caching",
      title: "Result cache & Materialized views",
  ...
  "DATABRICKS SQL": [
    ...
    {
      category: "Statistics & Planner",
      title: "Photon engine & predictive I/O",
  ...
  CLICKHOUSE: [
    ...
    {
      category: "I/O & File Layout",
      title: "PREWHERE for column pruning",
  ...
  PYTHON: [
    {
      category: "Concurrency / Threading",
      title: "GIL: threads vs processes",
    ...
    {
      category: "Memory & Caching",
      title: "__slots__ on hot classes",
  ...
  PYSPARK: [
    ...
    {
      category: "Partitioning",
      title: "Avoid tiny files / repartition before write",
    ...
    {
      category: "Memory & Caching",
      title: "cache() / persist(MEMORY_AND_DISK)",
    ...
    {
      category: "Functions & UDFs",
      title: "Avoid Python UDFs — use built-ins",
    ...
    {
      category: "Concurrency / Threading",
      title: "Broadcast joins for small tables",
    ...
    {
      category: "I/O & File Layout",
      title: "Parquet + predicate pushdown",
